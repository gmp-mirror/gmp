...
L(top):	vler	%v2,  0(idx,rp), 3
	vlvgp	%v22, %r12, %r13	C o HH  4 3
	vlvgp	%v20, %r0, %r1		C o LL  4 3
	lg	%r13, 32(idx,ap)	C o H   4
	lg	%r1,  40(idx,ap)	C o L   5
	vacq	%v25, %v31, %v2, %v30
	vacccq	%v30, %v31, %v2, %v30
	...
	vacq	%v31, %v21, %v23, %v28	C e HL  3 2
	vacccq	%v28, %v21, %v23, %v28
L(mid):	vler	%v2,  16(idx,rp), 3
	vlvgp	%v22, %r12, %r13	C o HH  6 5
	...
	vacq	%v31, %v21, %v23, %v28	C e HL  5 4
	vacccq	%v28, %v21, %v23, %v28
	la	idx, 32(idx)
	brctg	an, L(top)
...
L(odd):
	...
	mlgr	%r6,  b0
	vpdi	%v24, %v0, %v1, 4
	vacq	%v31, %v21, %v23, %v28
	vacccq	%v28, %v21, %v23, %v28
L(cj3):	vler	%v2,  16(idx,rp), 3
	vlvgp	%v22, %r12, %r13		C 6 5
	vacq	%v25, %v31, %v2, %v30
	vacccq	%v30, %v31, %v2, %v30
	vacq	%v26, %v24, %v25, %v29
	vacccq	%v29, %v24, %v25, %v29
	vaq	%v1,  %v22, %v27		C 6 5
	vlvgp	%v23, %r8, %r9			C   5 4
	vlvgp	%v21, %r6, %r7			C   5 4
	vster	%v26, 16(idx,rp), 3		C       3 2
	vpdi	%v24, %v1, %v0, 4		C   5 4
	vacq	%v31, %v21, %v23, %v28		C*  5 4
	vacccq	%v28, %v21, %v23, %v28
	vllezg	%v2,  32(idx,rp)
	vzero	%v3
	vpdi	%v2,  %v3, %v2, 0
	vacq	%v25, %v31, %v2, %v30		C*  5 4
	vacccq	%v30, %v31, %v2, %v30
	vacq	%v26, %v24, %v25, %v29		C*  5 4
	vacccq	%v29, %v24, %v25, %v29
	vster	%v26, 32(idx,rp), 3		C*  5 4
C	vzero	%v0
	vpdi	%v24, %v0, %v1, 4
	vacq	%v24, %v24, %v28, %v30
	vaq	%v24, %v24, %v29
	vlgvg	%r2,  %v24, 1		      C 7
	lmg	%r6,  %r13, 48(%r15)
	br	%r14
...
L(evn):	lg	%r13, 24(idx,ap)
	...
	vster	%v26, 16(idx,rp), 3
	vpdi	%v24, %v27, %v0, 4
	vacq	%v22, %v22, %v28, %v30
	vacq	%v26, %v22, %v24, %v29
